# trackbar module Created on 04-Apr-2023 01:48 PM; Author kcvinker[Added to Glance on 04-Jun-2023 01:20]
# TrackBar type
...
# TrackBar constructor 180, 45
proc newTrackBar*(parent: Form, x, y, w, h: int32): TrackBar {.exportc:"newTrackBar", stdcall, dynlib.} =
    new(result)
...
method createHandle*(this: TrackBar) =
    this.setTKBStyle()
...
proc `channelColor=`*(this: TrackBar, value: uint) {.inline.} =
    this.mChanColor = newColor(value)
    this.mChanStyle = ChannelStyle.csOutline
...
proc setTrackBarEvents(this: TrackBar, evtIndex: TrackBarEvents, funcPtr: EventHandler) =
    case evtIndex
    of tkbValueChanged: this.onValueChanged = funcPtr
    of tkbDragging: this.onDragging = funcPtr
    of tkbDragged: this.onDragged = funcPtr

proc setTrackBarProps(this: TrackBar, prop: TrackBarProps, value: pointer) =
    case prop
    of tkbTicColor: this.ticColor = cast[ref uint](value)[]
    of tkbChannelColor: this.channelColor = cast[ref uint](value)[]
    of tkbSelectionColor: this.selectionColor = cast[ref uint](value)[]
    of tkbChannelStyle: this.channelStyle = cast[ChannelStyle](cast[ref int](value)[])
    of tkbTicPosition: this.ticPosition = cast[TicPosition](cast[ref int](value)[])
    of tkbTrackChange: discard #this.trackChange = cast[TrackChange](cast[ref int](value)[])
    of tkbVertical: this.vertical = cast[bool](cast[ref int](value)[])
    of tkbReversed: this.reversed = cast[bool](cast[ref int](value)[])
    of tkbNoTics: this.noTics = cast[bool](cast[ref int](value)[])
    of tkbShowSelRange: this.showSelRange = cast[bool](cast[ref int](value)[])
    of tkbToolTip: this.toolTip = cast[bool](cast[ref int](value)[])
    of tkbCustomDraw: this.customDraw = cast[bool](cast[ref int](value)[])
    of tkbFreeMove: this.freeMove = cast[bool](cast[ref int](value)[])
    of tkbNoThumb: this.noThumb = cast[bool](cast[ref int](value)[])
    of tkbTicWidth: this.ticWidth = cast[ref int32](value)[]
    of tkbMinRange: this.minRange = cast[ref int32](value)[]
    of tkbMaxRange: this.maxRange = cast[ref int32](value)[]
    of tkbFrequency: this.frequency = cast[ref int32](value)[]
    of tkbPageSize: this.pageSize = cast[ref int32](value)[]
    of tkbLineSize: this.lineSize = cast[ref int32](value)[]
    of tkbTicLength: this.ticLength = cast[ref int32](value)[]
    of tkbValue: this.value = cast[ref int32](value)[]

proc getTrackBarProps(this: TrackBar, prop: TrackBarProps, value: pointer) =
    case prop
    of tkbTicColor: cast[ref uint](value)[] = this.ticColor.value
    of tkbChannelColor: cast[ref uint](value)[] = this.channelColor.value
    of tkbSelectionColor: cast[ref uint](value)[] = this.selectionColor.value
    of tkbChannelStyle: cast[ref int32](value)[] = int32(this.channelStyle)
    of tkbTrackChange: cast[ref int32](value)[] = int32(this.trackChange)
    of tkbTicPosition: cast[ref int32](value)[] = int32(this.ticPosition)
    of tkbVertical: cast[ref bool](value)[] = this.vertical
    of tkbReversed: cast[ref bool](value)[] = this.reversed
    of tkbNoTics: cast[ref bool](value)[] = this.noTics
    of tkbShowSelRange: cast[ref bool](value)[] = this.showSelRange
    of tkbToolTip: cast[ref bool](value)[] = this.toolTip
    of tkbCustomDraw: cast[ref bool](value)[] = this.customDraw
    of tkbFreeMove: cast[ref bool](value)[] = this.freeMove
    of tkbNoThumb: cast[ref bool](value)[] = this.noThumb
    of tkbTicWidth: cast[ref int32](value)[] = this.ticWidth
    of tkbMinRange: cast[ref int32](value)[] = this.minRange
    of tkbMaxRange: cast[ref int32](value)[] = this.maxRange
    of tkbFrequency: cast[ref int32](value)[] = this.frequency
    of tkbPageSize: cast[ref int32](value)[] = this.pageSize
    of tkbLineSize: cast[ref int32](value)[] = this.lineSize
    of tkbTicLength: cast[ref int32](value)[] = this.ticLength
    of tkbValue: cast[ref int32](value)[] = this.value
