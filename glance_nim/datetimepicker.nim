# datetimepicker module Created on 30-Mar-2023 12:22 PM [Added to Glance on 02-Jun-2023 02:56]
...
proc newDateTimePicker*(parent: Form, x, y, w, h: int32 = 10): DateTimePicker {.exportc:"newDateTimePicker", stdcall, dynlib.} =
    new(result)
...
method createHandle*(this: DateTimePicker) =
    this.setDTPStyles()
...
proc `formatString=`*(this: DateTimePicker, value: cstring) =
    this.mFmtStr = value
    this.mFormat = dfCustom
    if this.mIsCreated: this.sendMsg(DTM_SETFORMATA, 0, this.mFmtStr[0].unsafeAddr)

proc formatString*(this: DateTimePicker) : cstring {.inline.} = this.mFmtStr
...
proc setDateTimePickerEvents(this: DateTimePicker, evtIndex: DateTimePickerEvents, funcPtr: EventHandler) =
    case evtIndex
    of dtpValueChanged: this.onValueChanged = funcPtr
    of dtpCalendarOpened: this.onCalendarOpened = funcPtr
    of dtpCalendarClosed: this.onCalendarClosed = funcPtr
    of dtpTextChanged: this.onTextChanged = cast[DateTimeEventHandler](funcPtr)

proc setDateTimePickerProps(this: DateTimePicker, prop: DateTimePickerProps, value: pointer) =
    case prop
    of dtpFormatString: this.formatString = cast[cstring](value)
    of dtpFormat: this.format = cast[DTPFormat](cast[ref int](value)[])
    of dtpValue: this.value = (cast[ref DateAndTime](value))[]
    of dtpRightAlign: this.rightAlign = cast[bool](cast[ref int](value)[])
    of dtpNoToday: this.noToday = cast[bool](cast[ref int](value)[])
    of dtpShowUpdown: this.showUpdown = cast[bool](cast[ref int](value)[])
    of dtpShowWeekNumber: this.showWeekNumber = cast[bool](cast[ref int](value)[])
    of dtpNoTodayCircle: this.noTodayCircle = cast[bool](cast[ref int](value)[])
    of dtpNoTrailingDates: this.noTrailingDates = cast[bool](cast[ref int](value)[])
    of dtpShortDateNames: this.shortDateNames = cast[bool](cast[ref int](value)[])
    of dtpFourDigitYear: this.fourDigitYear = cast[bool](cast[ref int](value)[])

proc getDateTimePickerProps(this: DateTimePicker, prop: DateTimePickerProps, value: pointer) =
    case prop
    of dtpFormatString: cast[ref cstring](value)[] = this.formatString
    of dtpValue:  cast[ref DateAndTime](value)[] = this.value
    of dtpFormat: cast[ref int32](value)[] = int32(this.format)
    of dtpRightAlign: cast[ref bool](value)[]  = this.rightAlign
    of dtpNoToday: cast[ref bool](value)[] = this.noToday
    of dtpShowUpdown: cast[ref bool](value)[] = this.showUpdown
    of dtpShowWeekNumber: cast[ref bool](value)[] = this.showWeekNumber
    of dtpNoTodayCircle: cast[ref bool](value)[] = this.noTodayCircle
    of dtpNoTrailingDates: cast[ref bool](value)[] = this.noTrailingDates
    of dtpShortDateNames: cast[ref bool](value)[] = this.shortDateNames
    of dtpFourDigitYear: cast[ref bool](value)[] = this.fourDigitYear
