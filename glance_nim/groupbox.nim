# groupbox module Created on 31-Mar-2023 11:14 PM; Author kcvinker [Added to Glance on 02-Jun-2023 07:44]
...
proc newGroupBox*(parent: Form, text: LPCWSTR, x, y: int32 = 10, w, h: int32 = 150): GroupBox {.exportc:"newGroupBox", stdcall, dynlib.} =
    new(result)
...
method createHandle*(this: GroupBox) =
