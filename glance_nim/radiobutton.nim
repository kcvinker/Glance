# radiobutton module Created on 04-Apr-2023 02:34 AM; Author kcvinker [Added to Glance on 04-Jun-2023 00:43]
# RadioButton type
...
proc newRadioButton*(parent: Form, text: LPCWSTR, x, y, w, h: int32): RadioButton {.exportc:"newRadioButton", stdcall, dynlib.} =
    new(result)
...
method createHandle*(this: RadioButton) =
    this.setRBStyle()
...
proc rbWndProc(hw: HWND, msg: UINT, wpm: WPARAM, lpm: LPARAM, scID: UINT_PTR, refData: DWORD_PTR): LRESULT {.stdcall.} =
    ...
    of MM_NOTIFY_REFLECT:
        ...
        of CDDS_PREPAINT:
            ...
            DrawTextW(nmcd.hdc, this.mText[0].unsafeAddr, -1, nmcd.rc.unsafeAddr, this.mTxtFlag)
